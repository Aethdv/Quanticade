...
int SE_BETA_BASE = 63;
int SE_BETA_MULTIPLIER = 67;
int LDSE_MARGIN = 25;
int LMR_PV_NODE = 853;
int LMR_HISTORY_QUIET = 1116;
int LMR_HISTORY_NOISY = 1095;
int LMR_WAS_IN_CHECK = 787;
int LMR_IN_CHECK = 1014;
int LMR_CUTNODE = 1353;
int LMR_TT_DEPTH = 1029;
int LMR_TT_PV = 1151;
int LMR_TT_PV_CUTNODE = 820;
int LMR_TT_SCORE = 837;
int LMR_CUTOFF_CNT = 850;
int LMR_IMPROVING = 971;
int LMR_DEEPER_MARGIN = 34;
int LMP_BETA_MARGIN = 15;
int LMR_CORRECTION = 1953;
int LMR_HASH_FLAG_EXACT = 984;
int ASP_WINDOW = 14;
int QS_FUTILITY_THRESHOLD = 91;
int MO_SEE_THRESHOLD = 102;
int LMR_QUIET_HIST_DIV = 6411;
int LMR_CAPT_HIST_DIV = 8117;
int ASP_WINDOW_DIVISER = 28708;
int ASP_WINDOW_FAIL_LOW = 28;
int ASP_WINDOW_FAIL_HIGH = 60;
int HINDSIGH_REDUCTION_ADD = 2987;
int HINDSIGH_REDUCTION_RED = 2037;
int HINDSIGN_REDUCTION_EVAL_MARGIN = 91;
int PROBCUT_MARGIN = 238;
int PROBCUT_SEE_THRESHOLD = 94;
int MO_SEE_HISTORY_DIVISER = 30;
int MO_QUIET_HIST_MULT = 1063;
int MO_CONT1_HIST_MULT = 920;
int MO_CONT2_HIST_MULT = 951;
int MO_CONT4_HIST_MULT = 1026;
...
int QUIET_HISTORY_BONUS_MAX = 1130;
int QUIET_HISTORY_BASE_BONUS = 10;
int QUIET_HISTORY_FACTOR_BONUS = 159;
int QUIET_HISTORY_BASE_MALUS = 7;
int QUIET_HISTORY_FACTOR_MALUS = 227;
int QUIET_HISTORY_MAX_TT = 1453;
int QUIET_HISTORY_TT_FACTOR = 125;
int QUIET_HISTORY_TT_BASE = 76;

int CAPTURE_HISTORY_MALUS_MAX = 891;
int CAPTURE_HISTORY_BONUS_MAX = 1577;
int CAPTURE_HISTORY_BASE_BONUS = 10;
int CAPTURE_HISTORY_FACTOR_BONUS = 149;
int CAPTURE_HISTORY_BASE_MALUS = 10;
int CAPTURE_HISTORY_FACTOR_MALUS = 253;
int CAPTURE_HISTORY_QS_BONUS = 167;
int CAPTURE_HISTORY_QS_MALUS = 250;

int CONT_HISTORY_MALUS_MAX = 1246;
int CONT_HISTORY_BONUS_MAX = 2394;
int CONT_HISTORY_BASE_BONUS = 9;
int CONT_HISTORY_FACTOR_BONUS = 178;
int CONT_HISTORY_BASE_MALUS = 8;
int CONT_HISTORY_FACTOR_MALUS = 237;

int PAWN_HISTORY_MALUS_MAX = 923;
int PAWN_HISTORY_BONUS_MAX = 1358;
int PAWN_HISTORY_BASE_BONUS = 9;
int PAWN_HISTORY_FACTOR_BONUS = 182;
int PAWN_HISTORY_BASE_MALUS = 10;
int PAWN_HISTORY_FACTOR_MALUS = 138;

double LMP_MARGIN_WORSENING_BASE = 1.4196329887135342;
double LMP_MARGIN_WORSENING_FACTOR = 0.3995233232792034;
double LMP_MARGIN_WORSENING_POWER = 1.5776708048332917;
double LMP_MARGIN_IMPROVING_BASE = 2.9351150255703384;
double LMP_MARGIN_IMPROVING_FACTOR = 0.9106682099352611;
double LMP_MARGIN_IMPROVING_POWER = 1.9547892233193231;

double LMR_OFFSET_QUIET = 0.7308077562381605;
double LMR_DIVISOR_QUIET = 1.8571448050498718;
double LMR_OFFSET_NOISY = -0.0900346394754415;
double LMR_DIVISOR_NOISY = 2.458815789654523;

double NODE_TIME_MULTIPLIER = 2.399060211973212;
double NODE_TIME_ADDITION = 0.4635789865029885;
double NODE_TIME_MIN = 0.5424629207136534;

double EVAL_TIME_ADDITION = 1.1892727394836602;
double EVAL_TIME_MULTIPLIER = 0.050742710836530716;

int SEEPieceValues[] = {64, 331, 318, 577, 1580, 0, 0};

int mvv[] = {127, 364, 302, 488, 1355, 0};

int lmr[2][MAX_PLY + 1][256];

double bestmove_scale[5] = {2.4223871668404344, 1.3582525587816425,
                            1.1031145818151804, 0.8910081505093099,
                            0.7101307434175141};
...
static inline int16_t negamax(thread_t *thread, searchstack_t *ss,
  ...
  while ((move = select_next(&picker)) != 0) {
    ...
    if (depth >= 2 && moves_seen > 1 + root_node) {
      ...
      R -= improving * LMR_IMPROVING * 3 / 4;
      R -= improving * LMR_IMPROVING / 4 * !pv_node;
